--
-- CHECK_ACQUISIZIONE_VERBOSE_V  (View) 
--
CREATE OR REPLACE VIEW APPL_RINF_EVO.CHECK_ACQUISIZIONE_VERBOSE_V
(DATA, AVVIO, FINE, STAGING, NOTIFICA, 
 CONTROLLI, NOTIFICA_ANOM, CACHE, FULL, LOGS, 
 OPERATOR, STAGING_END, NOTIFICA_END, CONTROL_END, NOTIFICA_ANOM_END)
BEQUEATH DEFINER
AS 
SELECT
